export const decisions = [
  {
    ...
    choiceALabel: "Build deep expertise early",
    choiceBLabel: "Rotate broadly across functions",
    choiceAKey: "specializeEarly",
    choiceBKey: "rotateBroadly",
  },
  {
    id: "decision_02",
    ...
    choiceALabel: "Take the promotion and raise",
    choiceBLabel: "Stay in the work you love",
    choiceAKey: "chooseObjectiveSuccess",
    choiceBKey: "chooseSubjectiveSuccess",
  },
  {
    id: "decision_03",
    ...
    choiceALabel: "Commit to the long-term goal",
    choiceBLabel: "Chase the quicker, visible win",
    choiceAKey: "pursueLongTermGoal",
    choiceBKey: "pursueShortTermWin",
  },
  {
    id: "decision_04",
    ...
    choiceALabel: "Follow your genuine interests",
    choiceBLabel: "Take the higher-paying offer",
    choiceAKey: "followInterests",
    choiceBKey: "followPay",
  },
  {
    id: "decision_05",
    ...
    choiceALabel: "Prioritize organizational fit",
    choiceBLabel: "Prioritize job and task fit",
    choiceAKey: "prioritizeOrgFit",
    choiceBKey: "prioritizeJobFit",
  },
  {
    id: "decision_06",
    ...
    choiceALabel: "Actively reshape your role",
    choiceBLabel: "Stick to your job description",
    choiceAKey: "craftTheJob",
    choiceBKey: "stickToDescription",
  },
  {
    id: "decision_07",
    ...
    choiceALabel: "Pursue the calling full-time",
    choiceBLabel: "Pursue the calling on the side",
    choiceAKey: "pursueCallingFullTime",
    choiceBKey: "pursueCallingOnTheSide",
  },
  {
    id: "decision_08",
    ...
    choiceALabel: "Stay on the stable ladder",
    choiceBLabel: "Go self-directed and mobile",
    choiceAKey: "stayOnLadder",
    choiceBKey: "goSelfDirected",
  },
  {
    id: "decision_09",
    ...
    choiceALabel: "Take the demanding assignment",
    choiceBLabel: "Protect your nonwork time",
    choiceAKey: "takeStretchAssignment",
    choiceBKey: "protectNonworkTime",
  },
  {
    id: "decision_10",
    ...
    choiceALabel: "Work around the barrier",
    choiceBLabel: "Advocate to change the system",
    choiceAKey: "workAroundBarrier",
    choiceBKey: "advocateForChange",
  },
  {
    id: "decision_11",
    ...
    choiceALabel: "Retire fully and step away",
    choiceBLabel: "Continue in reduced capacity",
    choiceAKey: "retireFully",
    choiceBKey: "continueReducedCapacity",
  },
];
